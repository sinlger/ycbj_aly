...
const $$Privacy$1 = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<section> <div class="mx-auto w-full lg:px-24 max-w-7xl md:px-12 items-center px-8 py-24"> <div> <div class="relative mx-auto max-w-[40rem] pt-20 pb-24"> <h1 class="text-4xl tracking-tight font-medium text-black md:text-5xl">
Privacy policy
</h1> <p class="mt-4 text-base lea ding-7 text-base-500">
Last updated on January 01, 2023
</p> </div> </div> <div> <div class="mx-auto max-w-[40rem] prose-base prose text-base-500 prose-h3:text-black prose-a:font-semibold prose-a:text-accent-300 hover:prose-a:text-black"> <p>
...
Services means all services provided us to you, including (but not
          limited to) this Website.
</p> <p>
...
Their privacy policy can be viewed <a href="https://www.paypal.com/webapps/mpp/ua/privacy-full">
here
</a> </p> <h3>Merger, acquisition or asset sale</h3> <p>
...
If you believe that we have breached our obligations to you under this
          privacy policy or relevant privacy laws, please contact us at <a href="">
email@example
</a>
...
}, "E:/workSpace/ali_image/src/components/infopages/Privacy.astro", void 0);
...
}, "E:/workSpace/ali_image/src/pages/privacy.astro", void 0);

const $$file = "E:/workSpace/ali_image/src/pages/privacy.astro";
const $$url = "/privacy";
